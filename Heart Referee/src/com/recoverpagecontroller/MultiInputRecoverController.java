	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (reverse.equals("yes") || reverse == "yes") {
			...
			if (!(numberS1.isEmpty())) {
				...
				recoverTableDao.add2DwithR(number1, rNumber1, money);
				rCount = rCount + 1;
				shortMsg = numberS1;
			}
			if (!(numberS2.isEmpty())) {
				...
				recoverTableDao.add2DwithR(number2, rNumber2, money);
				rCount = rCount + 1;
			...
			if (!(numberS3.isEmpty())) {
				...
				recoverTableDao.add2DwithR(number3, rNumber3, money);
				rCount = rCount + 1;
			...
			if (!(numberS4.isEmpty())) {
				...
				recoverTableDao.add2DwithR(number4, rNumber4, money);
				rCount = rCount + 1;
			...
			if (!(numberS5.isEmpty())) {
				...
				recoverTableDao.add2DwithR(number5, rNumber5, money);
				rCount = rCount + 1;
			...
			if (!(numberS6.isEmpty())) {
				...
				recoverTableDao.add2DwithR(number6, rNumber6, money);
				rCount = rCount + 1;
			...
			if (!(numberS7.isEmpty())) {
				...
				recoverTableDao.add2DwithR(number7, rNumber7, money);
				rCount = rCount + 1;
			...
			if (!(numberS8.isEmpty())) {
				...
				recoverTableDao.add2DwithR(number8, rNumber8, money);
				rCount = rCount + 1;
			...
			if (!(numberS9.isEmpty())) {
				...
				recoverTableDao.add2DwithR(number9, rNumber9, money);
				rCount = rCount + 1;
			...
			if (!(numberS0.isEmpty())) {
				...
				recoverTableDao.add2DwithR(number0, rNumber0, money);
				rCount = rCount + 1;
